...
# Warm-Flow 1.8.8 端午节版
本版本主要针对上一个版本的一些问题进行修复，并且下个版本会新增大家期待的扩展节点，比如超时审批节点，短信发送节点等

### Bug 修复
- 流程图在PC端iframe首次加载不自动居中，需手动点击自适应按钮
- 当设置 onlyDesignShow: true,仅显示设计的时候样式出现问题
- 办理人前端显示与数据库不一致
- 修复历史任务，第一个节点创建时间，可能在开始节点创建时间之前
