...
### v1.8.9  2026-07-16
- feat：新增npm集成方案  @唐亚峰 | battcn
- fix： 移动端查看设计器的时候，默认使用initMimicData.json来初始化为仿钉钉数据
- update: 设计器整体样式布局统一风格，去除原来风格割裂的问题 @唐亚峰 | battcn


## 更新日志
### v1.8.8  2026-06-16
- [升级指南](./upgrade_guide.md#v1-8-8)
- fix: 流程图在PC端iframe首次加载不自动居中，需手动点击自适应按钮
- fix: 当设置 onlyDesignShow: true,仅显示设计的时候样式出现问题
- fix: 办理人前端显示与数据库不一致
- fix: 修复历史任务，第一个节点创建时间，可能在开始节点创建时间之前


### v1.8.7  2026-05-06
- [升级指南](./upgrade_guide.md#v1-8-7)
- feat: 设计器流程图适配手机端
...
- [fix] 修复创建监听器，在并行网关场景下只能获取第一个task的bug  感谢@dev78657
