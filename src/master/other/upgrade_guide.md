...
### v1.8.8
- 升级版本号就行
- 如果二开设计器，请自行手动同步，就不一一列举，参考工作流引擎源码中`warm-flow/warm-flow-ui`文件夹的提交记录，提交时间范围：`2026/5/6 10:36 ~ 2026/6/16 11:33`

### v1.8.7
- 升级版本号就行
- 如果二开设计器，请自行手动同步，就不一一列举，参考工作流引擎源码中`warm-flow/warm-flow-ui`文件夹的提交记录，提交时间范围：`2026/3/24 12:36 ~ 2026/5/6 10:36`


### v1.8.5
- 如果二开设计器，请自行手动同步，就不一一列举，参考工作流引擎源码中`warm-flow/warm-flow-ui`文件夹的提交记录，提交时间范围：`2025/11/13 16:06 ~ 2026/3/24 12:36`
