...
亲爱的 Warm-Flow 用户们，我们非常高兴地宣布 Warm-Flow 1.8.5 版本今日正式发布！

本次更新聚焦于提升您的工作流开发体验，带来了超时自动审批、监听器下拉选择、暂存功能等多项实用特性，同时优化了节点扩展属性，并完成了 SpringBoot4 和 Jackson3 的适配。无论您是追求高效开发的个人开发者，还是注重稳定性的企业用户，这些新功能都将让您的工作流开发更加得心应手。
