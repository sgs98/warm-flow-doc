...
- 开始学习前，请先了解<span class="wf-lead">[表结构](./table.md)</span>，不迷路
- 首次导入，先创建数据库，找到对应数据库的全量脚本<span class="wf-lead">[warm-flow-all.sql](https://github.com/sgs98/warm-flow/tree/main/sql/mysql)</span>，执行  
- 如果版本更新，找到对应数据库的更新版本，比如xx-upgrade，<span class="wf-lead">[warm-flow_x.x.x.sql](https://github.com/sgs98/warm-flow/tree/main/sql/mysql/v1-upgrade)</span>，执行
...
## **2、maven依赖**
- <span class="wf-lead">springboot 支持3、4版本（v2.0.0起已移除 springboot2 与 solon 适配）</span>
...
<span class="wf-lead">[https://gitee.com/vanlin/warm-flow-jpa.git](https://gitee.com/vanlin/warm-flow-jpa.git)</span>


### **2.4、BeetlSql**

<span class="wf-lead">[https://gitee.com/smartcity/warm-flow-beetlsql-solon.git](https://gitee.com/smartcity/warm-flow-beetlsql-solon.git)</span>
...
public void deployFlow() throws Exception {
    ...
    System.out.println("已部署流程的id：" + FlowEngine.defService().importIs(new FileInputStream(path)).getId());
}
```
...
public void startFlow() {
    ...
    // 操作者：办理人唯一标识（办理人权限标识 permissions 由 PermissionHandler 提供，实现后可不传）
...
## **4、设计器引入**
> <span class="wf-lead">通过jar包引入：[文档地址](./designerIntroduced.md)</span>
